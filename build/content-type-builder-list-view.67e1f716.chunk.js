"use strict";
(self["webpackChunkal_azhar_back"] = self["webpackChunkal_azhar_back"] || []).push([[5905],{
...
const CloseButton = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  position: absolute;
  display: none;
  top: 5px;
...
const StyledAddIcon = (0,styled_components_browser_esm["default"])((0,Plus/* default */.Z))`
...
`;
const FixedBox = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  ...
  left: 0;
`;
const ScrollableStack = (0,styled_components_browser_esm["default"])((0,Flex/* Flex */.k))`
  width: 100%;
  overflow-x: auto;
`;
const ComponentContentBox = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  padding-top: ${(0,dist/* pxToRem */.Q1)(90)};
`;
const ComponentStack = (0,styled_components_browser_esm["default"])((0,Flex/* Flex */.k))`
  flex-shrink: 0;
  width: ${(0,dist/* pxToRem */.Q1)(140)};
  height: ${(0,dist/* pxToRem */.Q1)(80)};
...
const IconBox = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  height: ${24 / 16}rem;
  width: ${24 / 16}rem;
  border-radius: 50%;
  display: flex;
...
`;
const ButtonBox = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
...
const BoxWrapper_BoxWrapper = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  position: relative;
`;
...
const IconBox = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])((0,_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x)) `
  height: ${24 / 16}rem;
  width: ${24 / 16}rem;
  border-radius: 50%;
  display: flex;
...
const ButtonBox = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])((0,_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x)) `
  border-radius: 0 0 ${({ theme }) => theme.borderRadius} ${({ theme }) => theme.borderRadius};
  display: block;
  width: 100%;
  border: none;
