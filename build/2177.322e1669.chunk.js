"use strict";
(self["webpackChunkal_azhar_back"] = self["webpackChunkal_azhar_back"] || []).push([[2177],{
...
const it = {
  ...
  "containers.HomePage.form.restrictedAccess.inputDescription": "Rendi l'endpoint della documentazione privato. Di default l'accesso \xE8 pubblico",
  "containers.HomePage.form.showGeneratedFiles": "Mostra file generati",
  "containers.HomePage.form.showGeneratedFiles.inputDescription": "Utile quando vuoi sovrascrivere la documentazione generata. \nIl plugin genera file suddivisi per modello e per plugin. \nAbilitando questa opzione sar\xE0 pi\xF9 semplice personalizzare la tua documentazione.",
  "error.deleteDoc.versionMissing": "La versione che stai tentando di cancellare non esiste.",
  "error.noVersion": "Una versione \xE8 richiesta",
  "error.regenerateDoc": "Si \xE8 verificato un errore durante la rigenerazione della documentazione",
