"use strict";
(self["webpackChunkal_azhar_back"] = self["webpackChunkal_azhar_back"] || []).push([[3650],{
...
var TableList = __webpack_require__(93184);
...
const BoxWithHeight = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  height: ${32 / 16}rem;
  display: flex;
  align-items: center;
`;
const TypographyMaxWidth = (0,styled_components_browser_esm["default"])((0,Typography/* Typography */.Z))`
  max-width: 100%;
`;
const ActionContainer = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  svg {
    path {
